...
def generate_launch_description():
    ...
    moveit_config = (
        MoveItConfigsBuilder("piper_x", package_name=package_name)
        .robot_description(file_path="config/piper_x.gazebo.urdf.xacro")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "world",
                default_value=str(package_share / "worlds" / "piper_x.world"),
