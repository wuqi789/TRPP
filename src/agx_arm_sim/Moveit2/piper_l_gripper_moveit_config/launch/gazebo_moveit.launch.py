...
def generate_launch_description():
    package_name = "piper_l_gripper_moveit_config"
    ...
    moveit_config = (
        MoveItConfigsBuilder("piper_l", package_name=package_name)
        .robot_description(file_path="config/piper_l.gazebo.urdf.xacro")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "world",
                default_value=str(package_share / "worlds" / "piper_l.world"),
