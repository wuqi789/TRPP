...
def generate_launch_description():
    package_name = "piper_h_gripper_moveit_config"
    ...
    moveit_config = (
        MoveItConfigsBuilder("piper_h", package_name=package_name)
        .robot_description(file_path="config/piper_h.gazebo.urdf.xacro")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "world",
                default_value=str(package_share / "worlds" / "piper_h.world"),
