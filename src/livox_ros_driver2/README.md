...
```json
{
  ...
  "HAP": {
    ...
    "host_net_info" : {
      "cmd_data_ip" : "192.0.2.5",  # host ip (it can be revised)
      "cmd_data_port": 56000,
      "push_msg_ip": "",
      "push_msg_port": 0,
      "point_data_ip": "192.0.2.5",  # host ip
      "point_data_port": 57000,
      "imu_data_ip" : "192.0.2.5",  # host ip
      "imu_data_port": 58000,
      "log_data_ip" : "",
      "log_data_port": 59000
    }
  ...
  "lidar_configs" : [
    {
      "ip" : "192.0.2.100",  # ip of the LiDAR you want to config
      "pcl_data_type" : 1,
      "pattern_mode" : 0,
      "blind_spot_set" : 50,
      "extrinsic_parameter" : {
...
| :------------------------- | ------- | ------------------------------------------------------------ | --------------- |
| ip             | String  | Ip of the LiDAR you want to config | 192.0.2.100 |
...
```json
{
  ...
  "lidar_configs" : [
    {
      "ip" : "192.0.2.100",  # ip of the HAP you want to config
      "pcl_data_type" : 1,
      "pattern_mode" : 0,
      "blind_spot_set" : 50,
      "extrinsic_parameter" : {
    ...
    {
      "ip" : "192.0.2.12",  # ip of the Mid360 you want to config
      "pcl_data_type" : 1,
      "pattern_mode" : 0,
      "extrinsic_parameter" : {
        "roll": 0.0,
...
```json
{
  "lidar_summary_info" : {
    ...
    "MID360": {
        ...
        "host_net_info": [
            {
                "lidar_ip": ["192.0.2.100"], # Lidar ip
                "host_ip": "192.0.2.5", # host ip
                "cmd_data_port": 56101,
                "push_msg_port": 56201,
                "point_data_port": 56301,
                "imu_data_port": 56401,
...
```json
{
  "lidar_summary_info" : {
    ...
    "MID360": {
        ...
        "host_net_info": [
            {
                "lidar_ip": ["192.0.2.200"], # Lidar ip
                "host_ip": "192.0.2.205", # host ip
                "cmd_data_port": 56101,
                "push_msg_port": 56201,
                "point_data_port": 56301,
                "imu_data_port": 56401,
    ...
    "lidar_configs": [
        {
            "ip": "192.0.2.200", # ip of the LiDAR you want to config
            "pcl_data_type": 1,
            "pattern_mode": 0,
            "extrinsic_parameter": {
                "roll": 0.0,
